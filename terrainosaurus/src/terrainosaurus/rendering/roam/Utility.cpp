...
// Camera Stuff
GLfloat gViewPosition[]		= { 0.f, 10.f, 0.f };
...
void IdleFunction(void)
{
	...
	if (gAnimating)
	{
		...
		gViewPosition[0] = ((GLfloat) MAP_SIZE / 4.f) + ((sinf(gAnimateAngle * M_PI / 180.f) + 1.f) * ((GLfloat) MAP_SIZE / 3.f));
		gViewPosition[2] = ((GLfloat) MAP_SIZE / 4.f) + ((cosf(gAnimateAngle * M_PI / 180.f) + 1.f) * ((GLfloat) MAP_SIZE / 3.f));
